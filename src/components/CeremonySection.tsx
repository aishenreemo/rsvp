...
const InfoCard = ({
    ...
    <motion.div
        ...
        className="bg-background  rounded-lg p-6 shadow-xl text-center border border-white/10"
    >
        ...
        <section id="ceremony" className="py-20 bg-primary">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-background/70 font-sans text-xl max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
                    <InfoCard icon={Calendar} title="Date & Time">
                        <p className="text-xl font-sans font-medium mb-1 text-foreground">{formattedDate}</p>
                        <p className="text-lg text-foreground font-sans ">{ceremonyTime}</p>
                    </InfoCard>
                    <InfoCard icon={MapPin} title="Venue & Location">
                        <p className="text-xl font-medium mb-1 text-foreground font-sans">{venue.name}</p>
                        <p className="text-lg text-foreground font-sans">{venue.address}</p>
                    </InfoCard>
                </div>
                    ...
                    >
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-background/80 font-sans font-medium">
